                ...
                <table class="table">
                    ...
                    foreach ($mosaics as $mosaic){
                        ...
                        <tr>
                            ...
                            <th><span class="glyphicon glyphicon-download mosaicloader" data-id="<?=(string)$mosaic->_id?>" aria-hidden="true"></span><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></th>
                        </tr>
                    <?php
                    }
                    ?>
